<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">Nexshop</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Reports &amp; Payments</span>
    </li>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="Listing">Listing</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
    ...
    <!-- Shipping & Forms -->
    <li class="menu-header small text-uppercase"><span class="menu-header-text">Products &amp; Shipment</span></li>
    <!-- Shipping -->
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
